...
export type VotedOpFragment = { __typename?: 'Opinion', votedUserCount: number, vote: Array<{ __typename?: 'Vote', user: { __typename?: 'User', id: number, sex: Sex, birth: any } }> } & { ' $fragmentName'?: 'VotedOpFragment' };
